    ...
    <!-- Voyage :   
    <br>
    Id : <?php echo $context->travel->id ?>
    <br>
    Conducteur : <?php echo $context->travel->conducteur ?>
    <br>
    Trajet : <?php echo $context->travel->trajet ?>
    <br>
    Tarif : <?php echo $context->travel->tarif ?>
    <br>
    Nombre de place : <?php echo $context->travel->nbPlace ?>
    <br>
    Heure de départ : <?php echo $context->travel->heureDepart ?>
    <br>
    Contraintes : <?php echo $context->travel->contraintes ?>
    <br>
