...
class mainController
{
	...
	public static function alertVoyage($request,$context){
		...
		if ($context->depart && $context->arrivee && $context->tarif || $context->tarif = 0 && $context->nbPlace && $context->heureDepart  || $context->heureDepart = 0 && $context->contraintes || $context->contraintes ="") {
			$context->status = 'success';
